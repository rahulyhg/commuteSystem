...
?>
    <table>
      <tr>
        ...
        <th></th>
        <!-- 180627 時間修正リスト追加 -->
        <th><select name="STAllHour" id="STAllHour">
          <?php
            for($j = 0; $j < 24; $j++) {
              if($j < 10) $j = "0".$j; // 1~9の場合
          ?>
        ...
        <select name="STAllMinute" id="STAllMinute">
          <?php
            for($j = 0; $j < 60; $j++) {
              if($j < 10) $j = "0".$j; // 1~9の場合
          ?>
        ...
        <th><select name="ETAllHour" id="ETAllHour">
          <?php
            for($j = 0; $j < 24; $j++) {
              if($j < 10) $j = "0".$j; // 1~9の場合
          ?>
        ...
        <select name="ETAllMinute" id="ETAllMinute">
          <?php
            for($j = 0; $j < 60; $j++) {
              if($j < 10) $j = "0".$j; // 1~9の場合
          ?>
        ...
        <th><select name="RTAllHour" id="RTAllHour">
          <?php
            for($j = 1; $j < 10; $j++) {
          ?>
              <option selected><?=$j?></option>
        ...
        <select name="RTAllMinute" id="RTAllMinute">
          <?php
            for($j = 0; $j < 60; $j++) {
              if($j < 10) $j = "0".$j; // 1~9の場合
          ?>
        ...
        <th><input type="button" value="一括入力" onclick='InsertTimeInfo()' class="input-btn"/></th>
      </tr>
      <tr>
      ...
      <tr>
        ...
        if($Daycheck == true) { ?>
          <td><input type="text" id="WPid<?=$i?>" value=<?=$WP?>></input></td> <!-- Workplace -->
          ...
          <td><input type="checkbox" id="modifycheck<?=$i?>" ></input></td>
          <!-- <td><?=$OT?></td> -->
        <?php } else { ?>
          <td><input type="text" id="WPid<?=$i?>" value=<?=$WP?>></input></td> <!-- Workplace -->
          <td><input type="text" id="STid<?=$i?>" value=<?=$ST?>></input></td> <!-- StartTime -->
